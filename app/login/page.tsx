...
function LoginErrorBanner() {
  ...
  return <div className="login-error" role="alert">{error}</div>;
}
    ...
    <main className="login-page">
      ...
      <section className="login-window">
        ...
        <form className="login-form" action="/api/auth/login" method="post">
          ...
          <button className="login-submit" type="submit"><span>Entrar no restaurante</span><ArrowRight size={18} /></button>
        </form>
